...
import Professionals from '@/components/professionals/Professionals.vue';
import Personals from '@/components/personals/Personals.vue';
...
export default {
  ...
  beforeDestroy () {
    // console.log('TLC: Works -> beforeDestroy');
